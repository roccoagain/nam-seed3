...
`20a04fcf466dc4233730412b120e5bbad72402c3`. `make/models.mk` copies the two source
...
the host test helper calls the constructor directly.

`tests/support/nam_lstm_activations.cpp` supplies only the upstream `using_fast_tanh` flag,
